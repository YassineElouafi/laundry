...
export function ChatIcon({ size = 20, color = '#15180e' }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path
...
export function BikeIcon({ size = 20, color = '#9aa091' }: { size?: number; color?: string }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Circle cx={5.5} cy={17.5} r={3.3} stroke={color} strokeWidth={1.8} />
      <Circle cx={18.5} cy={17.5} r={3.3} stroke={color} strokeWidth={1.8} />
      <Path
        d="M5.5 17.5l3-7h5l2.5 4.5M13 6h3l2.5 11.5M8.5 10.5H13"
        stroke={color}
        strokeWidth={1.8}
        strokeLinecap="round"
        strokeLinejoin="round"
